...
using wc_ad::wc::sensors::SensorState;
...
: Sensors(nh),
  ...
  sonar_(sonar)
{
  pub_ = nh->create_publisher<wc_msgs::msg::SensorState>(topic_name, this->qos_);
...
{
  auto msg = std::make_unique<wc_msgs::msg::SensorState>();
