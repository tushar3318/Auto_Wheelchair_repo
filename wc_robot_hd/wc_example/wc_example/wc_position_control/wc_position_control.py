...
from wc_example.wc_position_control.wc_path import wcPath
...
class wcPositionControl(Node):

    def __init__(self):
        super().__init__('wc_position_control')
        ...
        ************************************************************"""
        ...
        self.get_logger().info("wc position control node has been initialised.")
    ...
    def generate_path(self):
        ...
        if self.get_key_state is False:
            ...
            if self.step == 1:
                ...
                twist, self.step = wcPath.turn(angle, angular_velocity, self.step)
            ...
            # Step 2: Go Straight
                ...
                twist, self.step = wcPath.go_straight(distance, linear_velocity, self.step)
